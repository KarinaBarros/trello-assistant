...
def adicionar_tarefa(nome_da_task: str, descricao_da_task: str, due_date: str):
    ...
    try:
        dt = datetime.fromisoformat(due_date).astimezone(timezone.utc).isoformat()
    except ValueError:
        dt = due_date  # fallback se vier num formato inesperado
    ...
    meu_board = [b for b in boards if b.name == 'Agent-Dio'][0]
